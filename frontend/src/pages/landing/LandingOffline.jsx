      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <Reveal>
          <div style={{ textAlign: 'center', marginBottom: 80 }}>
            ...
            <p className="lp-section-sub" style={{ fontSize: '1.1rem', color: 'var(--lp-ink-faint)', maxWidth: 600, margin: '0 auto' }}>
        ...
        <div style={{ position: 'relative', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 40, alignItems: 'start', marginTop: 40 }}>
          ...
          <Reveal delay={1} style={{ zIndex: 1 }}>
            <div style={{ textAlign: 'center', position: 'relative' }}>
              <div style={{ width: 70, height: 70, borderRadius: '50%', background: 'var(--lp-paper-raised)', border: '2px solid rgba(239,68,68,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--lp-red)', margin: '0 auto 24px', boxShadow: '0 0 30px rgba(239,68,68,0.2)', position: 'relative' }}>
              ...
              <div style={{ fontWeight: 800, fontSize: '1.2rem', marginBottom: 10, color: 'var(--lp-ink)' }}>Se corta internet</div>
              <div style={{ color: 'var(--lp-ink-faint)', fontSize: '0.9rem', lineHeight: 1.6 }}>Microcorte o falta de datos. El sistema detecta la caída en milisegundos.</div>
            </div>
          </Reveal>
          <Reveal delay={2} style={{ zIndex: 1 }}>
            <div style={{ textAlign: 'center', position: 'relative' }}>
              <div style={{ width: 70, height: 70, borderRadius: '50%', background: 'var(--lp-paper-raised)', border: '2px solid rgba(16,185,129,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--lp-green)', margin: '0 auto 24px', boxShadow: '0 0 30px rgba(16,185,129,0.2)', position: 'relative' }}>
                <Svg.Check width={28} />
              ...
              <div style={{ fontWeight: 800, fontSize: '1.2rem', marginBottom: 10, color: 'var(--lp-ink)' }}>Seguís vendiendo</div>
              <div style={{ color: 'var(--lp-ink-faint)', fontSize: '0.9rem', lineHeight: 1.6 }}>Tu caja no se bloquea. Las transacciones se guardan cifradas en tu PC.</div>
            </div>
          </Reveal>
          <Reveal delay={3} style={{ zIndex: 1 }}>
            <div style={{ textAlign: 'center', position: 'relative' }}>
              <div style={{ width: 70, height: 70, borderRadius: '50%', background: 'var(--lp-paper-raised)', border: '2px solid rgba(245,158,11,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--lp-amber)', margin: '0 auto 24px', boxShadow: '0 0 30px rgba(245,158,11,0.2)', position: 'relative' }}>
              ...
              <div style={{ fontWeight: 800, fontSize: '1.2rem', marginBottom: 10, color: 'var(--lp-ink)' }}>Vuelve la conexión</div>
              <div style={{ color: 'var(--lp-ink-faint)', fontSize: '0.9rem', lineHeight: 1.6 }}>Las ventas se sincronizan a la nube automáticamente. Sin tocar nada.</div>
            </div>
          </Reveal>
        </div>
      </div>
