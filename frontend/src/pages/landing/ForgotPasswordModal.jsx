...
export default function ForgotPasswordModal({ showForgotPassword, setShowForgotPassword, setShowLoginModal }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(11,19,43,0.85)', backdropFilter: 'blur(20px)', padding: 20 }}
      onMouseDown={e => { if (e.target === e.currentTarget) { setShowForgotPassword(false); } }}>
      <div onMouseDown={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 440, background: 'var(--lp-paper-raised)', border: '1px solid var(--lp-line-strong)', borderRadius: 24, padding: '36px', position: 'relative', boxShadow: 'var(--lp-shadow-lg)' }}>
