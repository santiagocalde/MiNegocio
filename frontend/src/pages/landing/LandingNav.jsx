          ...
          <div style={{ position: 'relative' }} className="nav-dropdown-container"
            ...
            <div id="info-dropdown" style={{ opacity: 0, pointerEvents: 'none', transform: 'translateX(-50%) translateY(-10px)', transition: 'all 0.2s', position: 'absolute', top: '100%', left: '50%', background: 'var(--lp-paper-raised)', border: '1px solid var(--lp-line)', borderRadius: 14, padding: 10, display: 'grid', gridTemplateColumns: '1fr 1.2fr 1.4fr', gap: 8, width: 640, maxWidth: '90vw', boxShadow: 'var(--lp-shadow-md)' }}>
              ...
              <div>
                ...
                <a href="/comparar-sistemas-para-corralones/" className="lp-dropdown-item">Comparar corralones</a>
                <a href="/sistema-presupuestos-corralon/" className="lp-dropdown-item">Presupuestos para corral??n</a>
              </div>
              <div>
