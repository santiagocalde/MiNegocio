...
const FALLBACK_PLANS = [
  {
    ...
    monthly: 19999,
    yearly: 180000,
    desc: 'Todo lo necesario para vender, cobrar y controlar desde el primer día.',
    popular: false,
    features: [
      'Punto de venta con escáner de código de barras',
      'Vuelto automático · efectivo, transferencia, MP y tarjeta',
      ...
      'Cierre de caja con arqueo y reporte de turno',
      'Dashboard con ventas del día en tiempo real',
      'Impresión de tickets y comprobantes',
      'Funciona sin internet (modo offline)',
      'Hasta 3.500 productos · 2 usuarios',
    ],
    cta: 'Adquirir',
  },
  {
    ...
    monthly: 29999,
    yearly: 270000,
    desc: 'El plan más completo. Reportes, roles y todas las herramientas para crecer.',
    popular: true,
    features: [
  ...
  },
  {
    ...
    monthly: 39999,
    yearly: 360000,
    desc: 'Tu negocio con inteligencia artificial incorporada.',
    popular: false,
    features: [
      ...
      'Hasta 10.000 productos · usuarios ilimitados',
    ],
    cta: 'Adquirir',
  },
];
