            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.95rem', color: 'var(--lp-ink)', fontWeight: 500 }}>calderonsantiago2019@gmail.com</div>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ padding: 10, background: 'rgba(20,187,166,0.1)', borderRadius: 10 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.95rem', color: 'var(--lp-ink)', fontWeight: 500 }}>+54 9 11 4427-6384</div>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ padding: 10, background: 'rgba(20,187,166,0.1)', borderRadius: 10 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.95rem', color: 'var(--lp-ink)', fontWeight: 500 }}>Buenos Aires, Argentina</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lp-glass" style={{ padding: '32px', borderRadius: 20, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(35,65,105,0.85)' }}>
            {sent ? (
              <div style={{ textAlign: 'center', padding: '32px 0' }}>
                ...
                <h3 style={{ fontSize: '1.3rem', color: 'var(--lp-ink)', marginBottom: 8 }}>¡Mensaje enviado!</h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div>
                  ...
                  <input type="text" value={formData.nombre} onChange={e => setFormData({...formData, nombre: e.target.value})} placeholder="Tu nombre" style={{ width: '100%', padding: '10px 14px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: 'var(--lp-ink)', outline: 'none', fontSize: '0.9rem', transition: 'all 0.2s' }} onFocus={e => e.target.style.borderColor = 'var(--lp-primary)'} onBlur={e => e.target.style.borderColor = 'rgba(255,255,255,0.1)'} />
                </div>
                <div>
                  ...
                  <input type="text" value={formData.contacto} onChange={e => setFormData({...formData, contacto: e.target.value})} placeholder="Para contactarte" style={{ width: '100%', padding: '10px 14px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: 'var(--lp-ink)', outline: 'none', fontSize: '0.9rem', transition: 'all 0.2s' }} onFocus={e => e.target.style.borderColor = 'var(--lp-primary)'} onBlur={e => e.target.style.borderColor = 'rgba(255,255,255,0.1)'} />
                </div>
                <div>
                  <label style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.8)', fontWeight: 500, display: 'block', marginBottom: 6 }}>Mensaje</label>
                  <textarea value={formData.mensaje} onChange={e => setFormData({...formData, mensaje: e.target.value})} placeholder="¿En qué te podemos ayudar?" rows="4" style={{ width: '100%', padding: '10px 14px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: 'var(--lp-ink)', outline: 'none', fontSize: '0.9rem', transition: 'all 0.2s', resize: 'none' }} onFocus={e => e.target.style.borderColor = 'var(--lp-primary)'} onBlur={e => e.target.style.borderColor = 'rgba(255,255,255,0.1)'} />
                </div>
