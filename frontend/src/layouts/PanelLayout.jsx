  ...
  return (
    <div className="layout">
      ...
      <CloseTurnModal isClosingCaja={closeTurn.isClosingCaja} setIsClosingCaja={closeTurn.setIsClosingCaja}
        ...
        currentTurnId={auth.currentTurnId}
        onTurnClosed={() => { auth.setIsAuthenticated(false); auth.setCurrentTurnId(null); auth.setTurnOpenedAt(null); auth.setCurrentOperator(null); localStorage.removeItem('minegocio_current_operator'); localStorage.removeItem('minegocio_current_turn_id'); localStorage.removeItem('minegocio_turn_opened_at'); window.location.href = '/'; }} />
