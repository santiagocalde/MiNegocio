...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:4173", "http://127.0.0.1:4173", "http://localhost:1234", "http://127.0.0.1:1234", "http://localhost:5174", "http://127.0.0.1:5174", "http://localhost:5175", "http://127.0.0.1:5175", "http://localhost:5176", "http://127.0.0.1:5176"],
    allow_methods=["*"],
    allow_headers=["*"],
)
...
PLAN_LIMITS = {
    ...
    "simple": {"max_products": 3000,  "max_operators": 2, "multi_sucursal": False, "purchases": True,  "audit_cloud": False},
    "pro":    {"max_products": 10000, "max_operators": 5, "multi_sucursal": True,  "purchases": True,  "audit_cloud": True},
    "ia":     {"max_products": None,  "max_operators": None, "multi_sucursal": True, "purchases": True, "audit_cloud": True},
}
